...
| K2 | Grounding | Weakly covered module (e.g. `@webex/webex-core` Partial, all Untracked packages) | Claims cite real code (file path), not memory; uncovered public surfaces flagged `[NEEDS HUMAN INPUT]` | Important |
